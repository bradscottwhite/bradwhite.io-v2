    ...
    <nav className='fixed w-full z-20 top-0 left-0' style={{ backgroundColor: 'rgba(var(--dark-2), 0.5)' }}>
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className='flex md:order-2'>
          ...
          <button onClick={() => setOpen(!open)} type='button' className='inline-flex items-center p-2 text-sm text-light-2/75 hover:text-light-3 rounded-lg md:hidden hover:bg-dark-2 focus:outline-none focus:ring-2 focus:ring-dark-3'>
