...
const Front = () => {
  return (
    <div className='py-[28vh] pl-[15vw]'>
      <h1 className='bg-gradient-to-r from-lime-600 via-rose-400 to-violet-600 bg-clip-text text-transparent text-5xl py-2 opacity-75' style={{ fontFamily: 'Crenzo', filter: 'blur(1px)' }}>Brad White</h1>
      <h2 className='bg-gradient-to-r from-lime-500 via-rose-300 to-violet-500 bg-clip-text text-transparent text-2xl text-slate-100 pb-2' style={{ fontFamily: 'Baunk', filter: 'blur(1px)' }}>Full-stack Software Engineer</h2>
